...
@Configurable
@TeleOp(name = "DiffySwervePodTunerB", group = "testing")
public class SwerveModulePIDTestingB extends OpMode {
    ...
    public static double kD = 0.026; //0.0001
    public static double kS = 150;
    private double m1P = 15.0;
    private double m1I = 0.0;
    private double m1D = 0.0;
    private double m1F = 13.0;
    ...
    @Override
    public void init() {
        motor1 = hardwareMap.get(DcMotorEx.class, "motor3");
        motor2 = hardwareMap.get(DcMotorEx.class, "motor4");
        ...
        absoluteEncoder = hardwareMap.get(AnalogInput.class, "encoderB");
    ...
    public void loop() {
        ...
        double targetVel1 = steeringVelocity - optimizedDriveVelocity;
